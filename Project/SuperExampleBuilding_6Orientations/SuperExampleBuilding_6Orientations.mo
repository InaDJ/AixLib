model SuperExampleBuilding_6Orientations
  "This is the simulation model of SuperExampleBuilding_6Orientations"

	AixLib.Building.LowOrder.Multizone.MultizoneEquipped multizoneEquipped(
      buildingParam=Project.SuperExampleBuilding_6Orientations.SuperExampleBuilding_6Orientations_DataBase.SuperExampleBuilding_6Orientations_base()
  ...
  AixLib.Building.Components.Weather.Weather weather(
    ...
    SOD=AixLib.DataBase.Weather.SurfaceOrientation.SurfaceOrientationBaseDataDefinition(
        nSurfaces=6,
        name={"N", "O", "SO", "S", "W", "Hor"},
        Azimut={180.0,-90.0,-60.0,0.0,90.0,0.0},
        Tilt={90.0,90.0,90.0,90.0,90.0,0.0}))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    columns=2:2,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/SuperExampleBuilding_6Orientations/\TSetSuperExampleBuilding_6Orientations.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/SuperExampleBuilding_6Orientations/\AHU_SuperExampleBuilding_6Orientations.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    columns=2:4,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/SuperExampleBuilding_6Orientations/\InternalGains_SuperExampleBuilding_6Orientations.mat"))
  ...
  annotation (experiment(
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Text(
          ...
          textString="TB")}));
end SuperExampleBuilding_6Orientations;

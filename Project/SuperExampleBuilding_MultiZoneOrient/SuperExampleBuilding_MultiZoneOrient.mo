model SuperExampleBuilding_MultiZoneOrient
  "This is the simulation model of SuperExampleBuilding_MultiZoneOrient"

	AixLib.Building.LowOrder.Multizone.MultizoneEquipped multizoneEquipped(
      buildingParam=Project.SuperExampleBuilding_MultiZoneOrient.SuperExampleBuilding_MultiZoneOrient_DataBase.SuperExampleBuilding_MultiZoneOrient_base()
  ...
  AixLib.Building.Components.Weather.Weather weather(
    ...
    Azimut={180.0,-0.0,60.0,90.0,-90.0, 0}))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    columns=2:3,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/SuperExampleBuilding_MultiZoneOrient/\TSetSuperExampleBuilding_MultiZoneOrient.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/SuperExampleBuilding_MultiZoneOrient/\AHU_SuperExampleBuilding_MultiZoneOrient.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    columns=2:7,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/SuperExampleBuilding_MultiZoneOrient/\InternalGains_SuperExampleBuilding_MultiZoneOrient.mat"))
  ...
  annotation (experiment(
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Text(
          ...
          textString="TB")}));
end SuperExampleBuilding_MultiZoneOrient;
